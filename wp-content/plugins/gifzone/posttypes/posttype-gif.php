...
add_action('init', function(){
	...
	*/
	...
	$args = array(
		...
		'menu_icon' => 'dashicons-palmtree', // Custom post type icons -> https://developer.wordpress.org/resource/dashicons/
		'taxonomies' => array('category', 'post_tag'), // Uses the custom taxonomy created in this template
		'has_archive' => true,
...
/**
 * Set gif title and slug based on ID since we're not titling these items
 */
function update_gif_title($data, $postarr) {

	// Only run for gifs
	if ( $postarr['post_type'] == 'gif' )  {
...
add_filter('wp_insert_post_data', 'update_gif_title', '99', 2);
